...
public class Info {
	...
	public double calculateDistance(String x, String y, String lat, String lnt) {
		double xd = (double) Math.pow(Double.parseDouble(x)-Double.parseDouble(lat), 2);
		double yd = (double) Math.pow(Double.parseDouble(y)-Double.parseDouble(lnt), 2);
